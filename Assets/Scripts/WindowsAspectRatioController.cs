...
public class WindowsAspectRatioController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        InvokeRepeating("CheckAspectRatio", 4, 1);
    }
    ...
    private void CheckAspectRatio()
    {
        ...
        if (Math.Abs( currentAspectRatio - aspect) > 0.5f)
        {
    ...
    void Update()
    {
        ...
        /*
        if (!Screen.fullScreen && setWidth != -1 && setHeight != -1 && (Mathf.Abs(Screen.height - setHeight) > 50 ))
        {
