...
public class TwitchController : MonoBehaviour
{
    ...
    private OnTwitchCommandReceived onTwitchCommandReceived;
    private OnTwitchMessageReceived onTwitchMessageReceived;
    ...
    {
        onTwitchCommandReceived = new OnTwitchCommandReceived();
        onTwitchMessageReceived = new OnTwitchMessageReceived();
        Login(channelName);
    }
    ...
    public OnTwitchCommandReceived OnTwitchCommandReceived
    {
        get => onTwitchCommandReceived;
    }

    public OnTwitchMessageReceived OnTwitchMessageReceived
    {
        get => onTwitchMessageReceived;
    }
